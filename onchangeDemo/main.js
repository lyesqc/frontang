...
/* harmony import */ var _simplepagination_simplepagination_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./simplepagination/simplepagination.component */ "./src/app/simplepagination/simplepagination.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    { path: 'paginate', component: _simplepagination_simplepagination_component__WEBPACK_IMPORTED_MODULE_14__["SimplepaginationComponent"] },
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _simplepagination_simplepagination_component__WEBPACK_IMPORTED_MODULE_14__["SimplepaginationComponent"]
            ],
            imports: [
...
var Constantes = /** @class */ (function () {
    ...
    Constantes.redirect_uri = "http://localhost/";
...
/* harmony import */ var _constantes__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./constantes */ "./src/app/services/constantes.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.loadDataCollection = function () {
        return this.httpclient.get(_constantes__WEBPACK_IMPORTED_MODULE_2__["Constantes"].resource_uri + "user/collection");
    };
...
/***/ "./src/app/simplepagination/simplepagination.component.css":
/*!*****************************************************************!*\
  !*** ./src/app/simplepagination/simplepagination.component.css ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/app/simplepagination/simplepagination.component.html":
/*!******************************************************************!*\
  !*** ./src/app/simplepagination/simplepagination.component.html ***!
  \******************************************************************/
/*! no static exports found */
...
module.exports = "<table>\n  <tr *ngFor=\"let entity of items| slice: (page-1) * pageSize : (page-1) * pageSize + pageSize \">\n    <td> {{entity}}</td>\n\n  </tr>\n  <tr>\n    <td><a (click)=\"changepage(-1)\" ><=</a> {{page}} <a (click)=\"changepage(1)\" >=></a></td>\n  </tr>\n</table>\n"

/***/ }),

/***/ "./src/app/simplepagination/simplepagination.component.ts":
/*!****************************************************************!*\
  !*** ./src/app/simplepagination/simplepagination.component.ts ***!
  \****************************************************************/
/*! exports provided: SimplepaginationComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SimplepaginationComponent", function() { return SimplepaginationComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var SimplepaginationComponent = /** @class */ (function () {
    function SimplepaginationComponent(dataservice) {
    ...
    SimplepaginationComponent.prototype.ngOnInit = function () {
        var _this = this;
        /**
         * load data from server
         */
        this.dataservice.loadDataCollection().subscribe(function (res) {
            console.log('data pagination is ' + res);
            /*res.forEach(e=> {;
              console.log('add '+e);
              this.items.push(e)});
              */
            _this.items = res;
            _this.collectionCount = _this.items.length;
        });
    };
    SimplepaginationComponent.prototype.changepage = function (pagenum) {
        if (this.page == 1 && pagenum == -1)
            return;
        this.page += pagenum;
    };
    SimplepaginationComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-simplepagination',
            template: __webpack_require__(/*! ./simplepagination.component.html */ "./src/app/simplepagination/simplepagination.component.html"),
            styles: [__webpack_require__(/*! ./simplepagination.component.css */ "./src/app/simplepagination/simplepagination.component.css")]
        }),
...
var StudentComponent = /** @class */ (function () {
    function StudentComponent(currentRoute) {
